...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './students.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_STUDENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STUDENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STUDENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STUDENTS actions', async () => {
      const expectedActions = [
        {
