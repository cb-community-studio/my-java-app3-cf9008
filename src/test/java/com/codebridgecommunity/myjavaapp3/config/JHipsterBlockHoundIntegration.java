...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.codebridgecommunity.myjavaapp3.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside(
            "com.codebridgecommunity.myjavaapp3.security.DomainUserDetailsService",
